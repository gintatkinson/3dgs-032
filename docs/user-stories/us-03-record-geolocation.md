...
## Parent Epic
- [ ] #5 - [epic-01-geo-location](https://github.com/gintatkinson/3dgs-032/tree/main/docs/epics/epic-01-geo-location.md) (Contains the overarching specification for geo-location records)
...
- [ ] #11 - [Location Choice](https://github.com/gintatkinson/3dgs-032/tree/main/docs/features/feat-04-location-choice.md) (Provides the container choice between ellipsoid and cartesian)
- [ ] #12 - [Location Ellipsoid](https://github.com/gintatkinson/3dgs-032/tree/main/docs/features/feat-05-location-ellipsoid.md) (Provides latitude, longitude, and height coordinate attributes)
- [ ] #14 - [Location Cartesian](https://github.com/gintatkinson/3dgs-032/tree/main/docs/features/feat-06-location-cartesian.md) (Provides x, y, z coordinate attributes)
