...
## Parent Epic
- [ ] #5 - [epic-01-geo-location](https://github.com/gintatkinson/3dgs-032/blob/main/docs/epics/epic-01-geo-location.md) (Contains the base geo-location requirements under which velocity is calculated)
...
- [ ] #13 - [Velocity](https://github.com/gintatkinson/3dgs-032/blob/main/docs/features/feat-07-velocity.md) (Provides the base attributes v-north and v-east used for derivation)
