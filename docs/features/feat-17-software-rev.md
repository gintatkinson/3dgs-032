...
schema_containers:
  - path: "nwi:network-inventory/nwi:network-elements/nwi:network-element/nwi:components/nwi:component/nwi:software-rev"
    node_type: list
---

# Feature: Software Revision
...
## Description
This feature provides the capability to retrieve and manage software revisions associated with a component.
...
- **Given** a network element component running software.
- **When** the `software-rev` list is queried.
- **Then** the list of software modules is returned.
...
- **Data Source Bindings:** /nwi:network-inventory/nwi:network-elements/nwi:network-element/nwi:components/nwi:component/nwi:software-rev
