...
## Description
This feature specifies the Geodetic System attributes.
...
classDiagram
    ...
    class GeodeticSystem {
        ...
        +String coord-accuracy "[0..1]"
        +String height-accuracy "[0..1]"
    }
...
**Scenario 1: Viewing Geodetic System**
...
- **Data Source Bindings:** /ietf-geo-location:geo-location/reference-frame/geodetic-system
